main: main.cpp  Include/Drawable/Button.cpp Include/Entity/Brute.cpp Include/Entity/Pilgrim.cpp Include/Entity/Viking.cpp Include/Entity/Golem.cpp Include/Entity/Entity.cpp Include/Entity/Player.cpp Include/Drawable/DynamicSprite.cpp Include/Drawable/Sprite.cpp Include/Drawable/Text.cpp Include/Instance/Game.cpp Include/State/PlayState.cpp Include/State/MenuState.cpp Include/State/State.cpp Include/State/PickState.cpp Include/State/MapState.cpp
	g++ main.cpp Include/Drawable/Button.cpp Include/Entity/Brute.cpp Include/Entity/Pilgrim.cpp Include/Entity/Viking.cpp Include/Entity/Golem.cpp Include/Entity/Entity.cpp Include/Entity/Player.cpp Include/Drawable/DynamicSprite.cpp Include/Drawable/Sprite.cpp Include/Drawable/Text.cpp Include/Instance/Game.cpp Include/State/PlayState.cpp Include/State/MenuState.cpp Include/State/State.cpp Include/State/PickState.cpp Include/State/MapState.cpp -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -std=c++11 -o main.out
	./main.out

mac: main.cpp  Include/Drawable/Button.cpp Include/Entity/Brute.cpp Include/Entity/Pilgrim.cpp Include/Entity/Viking.cpp Include/Entity/Golem.cpp Include/Entity/Entity.cpp Include/Entity/Player.cpp Include/Drawable/DynamicSprite.cpp Include/Drawable/Sprite.cpp Include/Drawable/Text.cpp Include/Instance/Game.cpp Include/State/PlayStateMac.cpp Include/State/MenuState.cpp Include/State/State.cpp Include/State/PickState.cpp Include/State/MapState.cpp
	g++ main.cpp Include/Drawable/Button.cpp Include/Entity/Brute.cpp Include/Entity/Pilgrim.cpp Include/Entity/Viking.cpp Include/Entity/Golem.cpp Include/Entity/Entity.cpp Include/Entity/Player.cpp Include/Drawable/DynamicSprite.cpp Include/Drawable/Sprite.cpp Include/Drawable/Text.cpp Include/Instance/Game.cpp Include/State/PlayStateMac.cpp Include/State/MenuState.cpp Include/State/State.cpp Include/State/PickState.cpp Include/State/MapState.cpp -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio -std=c++11 -o main.out
	./main.out
